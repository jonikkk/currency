...
# EMAIL_PORT = 587
# EMAIL_HOST_PASSWORD = 'tckgcyiarsaxodee'
# EMAIL_USE_TLS = True
# EMAIL_USE_SSL = False
...
FLOWER_BROKER_URL = f'amqp://{RABBITMQ_USER}:{RABBITMQ_PASS}@{RABBITMQ_HOST}:{RABBITMQ_PORT}'
...
CELERY_BEAT_SCHEDULE = {
    ...
    'parse_website_obmen_dp_ua': {
        'task': 'currency.tasks.parse_website_obmen_dp_ua',
        'schedule': crontab(minute='*/5')
